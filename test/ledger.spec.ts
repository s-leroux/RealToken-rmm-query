...
import { Ledger, sort, join } from "../src/ledger"
import { ERC20TokenTransfer } from "../src/transaction"
  ...
  "result": [
    {
      ...
      "nonce": "35",
      "blockHash": "0xfeb05d7771c014c7d425a6e8cc4be24e274fb5a1c561bb54371de2d0bdb3da3b",
    ...
    },
    {
      ...
      "nonce": "1",
      "blockHash": "0xd28b8455a2f550ba3e524b3cb7817c5401bd52c25bfee1943a38bda8244951d9",
...
describe("The Ledger", () => {
  ...
  describe("union method", () => {
    it('should accept arrays of transactions', () => {
      const transactions = [
        new ERC20TokenTransfer(swarm, ERC20TokenTransferEvents.result[0]),
        new ERC20TokenTransfer(swarm, ERC20TokenTransferEvents.result[1]),
      ]
